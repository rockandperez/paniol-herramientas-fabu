...
<head runat="server">
    ...
    <title>Taller de Herramientas - Admisnitracion de Usuarios</title>
...
<body>
    ...
    <tr class="table-row">
        ...
        <td class="table-cell">
	        Estado
                    <asp:DropDownList ID="ddl_filtro_estado" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_filtro_estado_SelectedIndexChanged">
    ...
    <tr class="table-row">
        ...
        <td class="table-cell">
	        Rol
                    <asp:DropDownList ID="ddl_filtro_rol" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddl_filtro_rol_SelectedIndexChanged" Width="200px">
                    </asp:DropDownList>
	</td>
	<td class="table-cell">
	</td>
    ...
    <tr class="table-row">
        ...
        <td class="table-cell">
	        Nombre y apellido
                        <asp:TextBox ID="txt_filtro_nombre" runat="server" Width="200px" OnTextChanged="txt_filtro_nombre_TextChanged"></asp:TextBox>
	</td>
	<td class="table-cell">
	</td>
    </tr>
    <tr class="table-row">
        ...
        <td class="table-cell">
                        <asp:Button ID="btn_filtro_nomape" runat="server" OnClick="btn_filtro_nomape_Click" Text="Buscar" />
	</td>
	<td class="table-cell"></td>
    </tr>
    <tr class="table-row">
        ...
        <td class="table-cell" colspan="3">
            <asp:GridView ID="gv_usuarios" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True" OnRowCancelingEdit="gv_usuarios_RowCancelingEdit" OnRowDeleting="gv_libros_RowDeleting" OnRowEditing="gv_usuarios_RowEditing" OnRowUpdated="gv_usuarios_RowUpdated" OnRowUpdating="gv_usuarios_RowUpdating" class="display" UseAccessibleHeader="False" AllowPaging="True" OnPageIndexChanging="gv_usuarios_PageIndexChanging" PageSize="5" OnSelectedIndexChanged="gv_usuarios_SelectedIndexChanged" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Contraseña" ShowHeader="False">
                        <ItemTemplate>
                            <asp:Button ID="btn_blanqueo" runat="server" BackColor="#FFCC99" BorderStyle="None" CommandArgument='<%# Eval("usuario") %>' CommandName="eventoBlanquear" OnCommand="btn_blanqueo_Command" OnClientClick="return alerta_blanqueo('Seguro que desea blanquear la password?')" Text="Blanquear Pass" Width="122px" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
    ...
    <tr class="table-row">
        <td class="table-cell">
	        &nbsp;</td>
        <td class="table-cell">
                    <asp:Button ID="BtNuevo" runat="server" OnClick="BtNuevo_Click" Text="NUEVO USUARIO" />
	</td>
	<td class="table-cell">
	    &nbsp;</td>
    </tr>
